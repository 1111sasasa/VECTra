...
def evaluation(source_city, target_city, exp_path, model_name, start_time):
    ...
    feature_df = pd.read_csv("/home/shzheng2025/data/{}/edge_features.csv".format(target_city))
    num_nodes = len(feature_df)
    print("num_nodes:", num_nodes)

    # load adj
    edge_index = np.load("/home/shzheng2025/data/{}/line_graph_edge_idx.npy".format(target_city))
    print("edge_index shape:", edge_index.shape)

    # load origin train data
    test_node_data = pickle.load(
        open('/home/shzheng2025/data/{}/{}_1101_1115_data_sample10w.pkl'.format(target_city, target_city), 'rb'))
    ...
    test_seq_data = pickle.load(
        open('/home/shzheng2025/data/{}/{}_1101_1115_data_seq_evaluation.pkl'.format(target_city, target_city),
             'rb'))
    ...
    geometry_df = pd.read_csv("/home/shzheng2025/data/{}/edge_geometry.csv".format(target_city))

    trans_mat = np.load('/home/shzheng2025/data/{}/transition_prob_mat.npy'.format(target_city))
